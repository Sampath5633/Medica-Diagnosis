        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-20">
          <div className="max-w-4xl text-center mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 px-2">
              MEDICA – Multimodel Engine for Diagnosis, Intervention, Care and Assistance
            </h1>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-center md:text-left">
          <p className="text-blue-700 font-medium">
            &copy; {new Date().getFullYear()} MEDICA - Multimodel Engine for Diagnosis, Intervention, Care and Assistance
          </p>
